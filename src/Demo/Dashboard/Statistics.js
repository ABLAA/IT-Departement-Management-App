                            ...
                            <Card.Body className='pb-0'>
                                <Table responsive hover>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href={DEMO.BLANK_LINK} className="label theme-bg f-12 text-white">Active</a></td>
                                        <td className="text-right"><a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-c-yellow"/></a>
                                            <a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-c-yellow"/></a>
                                            <a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-c-yellow"/></a>
                                            <a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-c-yellow"/></a>
                                            <a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-black-50"/></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href={DEMO.BLANK_LINK} className="label theme-bg2 f-12 text-white">Not Active</a></td>
                                        <td className="text-right"><a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-c-yellow"/></a>
                                            <a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-c-yellow"/></a>
                                            <a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-c-yellow"/></a>
                                            <a href={DEMO.BLANK_LINK}><i className="fa fa-star f-18 text-black-50"/></a>
